...
<main id="main" class="main">
    <div class="card">
        ...
        <div class="card-body">
        <form method="POST" action="{{route('setups.assign.subject.update',$editData[0]->class_id)}}" id="editSubAssignForm">
            @csrf
            <div class="add_item">
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <div class="form-floating mb-3">
                            <select name="class_id" class="form-select" id="floatingSelect" aria-label="Select Class">
                                ...
                                <option value="{{$class->class_id}}" {{($editData[0]->class_id==$class->class_id)?"selected":""}}>{{$class->class_name}}</option>
                                 @endforeach
                            </select>
                ...
                <div class="row g-3" id="delete_whole_extra_item_add">
                    <div class="row g-3">
                        ...
                        <div class="form-group col-md-2">
                            <div class="form-floating mb-3">
                                <input name="full_mark[]" type="text" value="{{$data->full_mark}}" class="form-control" id="floatingFeeAmmount" placeholder="Full Marks">
                        ...
                        <div class="form-group col-md-2">
                            <div class="form-floating mb-3">
                                <input name="pass_mark[]" type="text" value="{{$data->pass_mark}}" class="form-control" id="floatingFeeAmmount" placeholder="Pass Mark">
